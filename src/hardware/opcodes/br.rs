...
mod tests {
    ...
    fn test_01() {
        ...
        vm.update_register_value(registers::RR2, 0).unwrap();
        ...
        assert_eq!(96, vm.get_register_value(registers::RPC).unwrap());
    }
    ...
    fn test_02() {
        ...
        let mut vm = VM::new();
        vm.update_register_value(registers::RR1, 1).unwrap();
        vm.update_register_value(registers::RR2, 4).unwrap();
        ...
        assert_eq!(65, vm.get_register_value(registers::RPC).unwrap());
    }
    ...
    fn test_03() {
        ...
        assert_eq!(67, vm.get_register_value(registers::RPC).unwrap());
    }
    ...
    fn test_04() {
        ...
        let mut vm = VM::new();
        vm.update_register_value(registers::RR1, 162).unwrap();
        vm.update_register_value(registers::RR2, 0).unwrap();

        // This means 'Add RR1 and RR2 and put the result on RR3'
        let add_instr: u16 = 0b0101011001000010;
        and(add_instr, &mut vm).unwrap();
        ...
        assert_eq!(97, vm.get_register_value(registers::RPC).unwrap());
    }
    ...
    fn test_05() {
        ...
        assert_eq!(225, vm.get_register_value(registers::RPC).unwrap());
    }
}
